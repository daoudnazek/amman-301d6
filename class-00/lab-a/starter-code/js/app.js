...
function displayPics(){
  ...
  // let allows us to declare variable only in the scope of block statment which is function displayPics in the previous lines,
  // so when we tried to console log rando , it gave error because it`s only defined inside the function displayPics block and not globally.
  console.log(viewed);
